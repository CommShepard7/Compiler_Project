...
let runtamcmde = "java -jar /home/shepard/Документы/TDL/Compilateur/sourceEtu/runtam.jar"
...
let%expect_test "testPointeurFonction1" = 
runtam "../../fichiersRat/src-rat-tam-test/testPointeurFonction1.rat";
  [%expect{| 20 |}]

let%expect_test "testPointeurFonction2" = 
  runtam "../../fichiersRat/src-rat-tam-test/testPointeurFonction2.rat";
  [%expect{| 2520 |}]

let%expect_test "testPointeurFonction3" = 
  runtam "../../fichiersRat/src-rat-tam-test/testPointeur3.rat";
  [%expect{| 15 |}]

let%expect_test "testTypeNomme1" = 
  runtam "../../fichiersRat/src-rat-tam-test/testTypeNomme1.rat";
  [%expect{| 2 |}]

let%expect_test "testTypeNomme1" = 
  runtam "../../fichiersRat/src-rat-tam-test/testTypeNomme2.rat";
  [%expect{| true |}]

let%expect_test "testTresComplexe" = 
  runtam "../../fichiersRat/src-rat-tam-test/testTypeTresComplexe.rat";
  [%expect{| 10 |}]

let%expect_test "testPlusEgal1" = 
  runtam "../../fichiersRat/src-rat-tam-test/testPlusEgal1.rat";
  [%expect{| 7[37/40] |}]

let%expect_test "testPlusEgalStruct" = 
  runtam "../../fichiersRat/src-rat-tam-test/testPlusEgalStruct.rat";
  [%expect{| 3[1/4] |}]

let%expect_test "testStruct" = 
  runtam "../../fichiersRat/src-rat-tam-test/testStruct.rat";
  [%expect{| 4835 |}]

let%expect_test "testStruct2" = 
  runtam "../../fichiersRat/src-rat-tam-test/testStruct2.rat";
  [%expect{| 12 |}]

let%expect_test "testStruct3" = 
  runtam "../../fichiersRat/src-rat-tam-test/testStruct3.rat";
  [%expect{| 3 |}]

let%expect_test "testAll" = 
  runtam "../../fichiersRat/src-rat-tam-test/testAll.rat";
